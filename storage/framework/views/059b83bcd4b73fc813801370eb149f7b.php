...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 py-12 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 min-h-screen">
            <div>
                <a href="/">
...
<?php /**PATH /home/G5/Documents/pcs/website/webprog-project/webprog-project/resources/views/layouts/guest.blade.php ENDPATH**/ ?>