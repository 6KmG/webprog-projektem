    ...
    <body class="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 h-screen flex items-center justify-center text-white">
        ...
        <div class="text-center p-10 md:p-20 rounded-3xl bg-gray-900 bg-opacity-60 shadow-xl transform transition-all duration-500 hover:scale-105" data-aos="fade-up">
            ...
            <div class="mt-8 space-x-4">
                <!-- Login Button -->
                <a href="<?php echo e(route('login')); ?>" class="inline-block bg-gray-300 text-black px-8 py-3 rounded-xl text-xl font-medium hover:bg-white transform transition duration-300 ease-in-out animate__animated animate__zoomIn hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-gray-100 focus:ring-opacity-50" data-aos="zoom-in" data-aos-delay="1000">
                    Login
                </a>
                
                <!-- Register Button -->
                <a href="<?php echo e(route('register')); ?>" class="inline-block bg-gray-300 text-black px-8 py-3 rounded-xl text-xl font-medium hover:bg-white transform transition duration-300 ease-in-out animate__animated animate__zoomIn hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-gray-100 focus:ring-opacity-50" data-aos="zoom-in" data-aos-delay="1200">
                    Register
                </a>
            </div>
        </div>
...
<?php /**PATH /home/G5/Documents/pcs/website/webprog-project/webprog-project/resources/views/welcome.blade.php ENDPATH**/ ?>